 ...
 */
export class RedFloat32DataEncoder {
  ...
  encode(src, textureSize) {
    ...
    if (src.constructor !== Float32Array) {
      console.log('Encoder', 'data was not of type Float32; creating new Float32Array');
      source = new Float32Array(src);
    }
    if (textureSize * this.channelSize > src.length) {
      console.log('Encoder', 'Source data too small. Allocating larger array');
      source = src;
 ...
 */
export class RGBAFloatDataEncoder {
  ...
  encode(src, textureSize) {
    let dest = src;
    if (this.channelSize === 1) {
      console.log('Encoder', 'Exploding into a larger array');
