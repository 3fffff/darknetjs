...
export function convolutional(layers) {
  ...
  for (let i = 0; i < l.batch; ++i) {
    for (let j = 0; j < l.groups; ++j) {
      ...
      if (delta) {
        im2col(delta.subarray(x_offset * group), col_buffer_data, l.c / l.groups, l.h, l.w, l.size, l.size, l.dilation, l.dilation, l.pad, l.pad, l.pad, l.pad, l.stride_y, l.stride_x);
