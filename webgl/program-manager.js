...
class ProgramManager {
  ...
  compile(fragShaderScript) {
    if (!this.vertexShader) {
      console.log('ProrgramManager', 'Compiling and caching Vertex shader for the first time');
      const vertexShaderScript = getVertexShaderSource(this.glContext.version);
      this.vertexShader = this.glContext.compileShader(vertexShaderScript, this.glContext.gl.VERTEX_SHADER);
    }
    console.log('ProrgramManager', `FragShader:${fragShaderScript}`);
  ...
  bindOutput(td) {
    console.log('ProrgramManager', `Binding output texture to Framebuffer: w/h=${td.width}/${td.height}, shape=${td.channels}`);
